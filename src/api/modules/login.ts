...
export const loginApi = (params: Login.ReqLoginForm) => {
	return http.post<Login.ResLogin>(`/iot/platformapi/login`, params, { headers: { noLoading: true } }); // 正常 post json 请求  ==>  application/json
...
export const getAuthMenuListApi = () => {
	return http.get<Menu.MenuOptions[]>(`/iot/platformapi/permission/component`, {}, { headers: { noLoading: true } });
};
